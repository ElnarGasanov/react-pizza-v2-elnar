...
import { deletePizzaOnCart, plusPizza, minusPizza, cartSelector } from '../../redux/slices/cartSlice.js'

const CartItem = ({ title, price, imageUrl, count = 0, sizes, id, types,}) => {
    ...
    const onClickDelete = () => {
        if (window.confirm('are u sure remove this pizza?')) {
            dispatch(deletePizzaOnCart(id))
        }
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <div onClick={count > 1 ? onClickMinus : onClickDelete} className="button button--outline button--circle cart__item-count-minus">
